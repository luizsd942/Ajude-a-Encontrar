...
//		double LatToRad =(firstLatitude - secondLatitude) * Math.PI / 180;
//		double longToRad = (firstLongitude - secondLongitude) * Math.PI / 180;
//		
//		double a = Math.sin(LatToRad/2) * Math.sin(LatToRad) + 
//				 Math.cos(firstLatitude * Math.PI / 180) * Math.cos(secondLatitude * Math.PI / 180) *
//				    Math.sin(longToRad/2) * Math.sin(longToRad/2);
